...
impl Bus {
    ...
    pub fn read_byte(self: &Self, addr: u16) -> u8 {
        ...
        let byte = match addr {
            ...
            0xFF03..=0xFF0F => self.io.read_byte(addr),
    ...
    pub fn write_byte(self: &mut Self, addr: u16, data: u8) {
        ...
        match addr {
            ...
            SOUND_START..=SOUND_END => self.sound.write_byte(addr, data),
            PCM12 | PCM34 => self.sound.write_byte(addr, data),
            WAVE_RAM_START..=WAVE_RAM_END => self.sound.write_byte(addr, data),
            0xFF03..=0xFF0F => self.io.write_byte(addr, data),
